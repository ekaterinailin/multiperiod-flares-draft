...
\\
V374 Peg, an M4 dwarf rotating at $0.446$ d~\citep{newton2016} shows no dominating polar spot, and weak contrast small spots on its surface at most~\citep{morin2008peg}. Its spot configuration appears very stable on a 16 yr baseline with small day to day variations, and frequent flaring is observed~\citep{vida2016}.
\\
...
\textbf{Are these stars all close-by? If yes, our results also extent the number of possible stars for which we can constrain the latitudes.}
