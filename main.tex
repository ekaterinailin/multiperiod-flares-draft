...
only one FCUFR, an L1 dwarf, WISEP J190848.47+401106.8, or \FE, was monitored during Quarters 10-17 in 30-minute cadence, and during Quarter 14 in 1-minute cadence~\citep{gizis2013}. It showed very stable rotation with $P=8.9$ h, 
...
\label{sec:propsB}
%TIC 449
\FB\; is an M6 dwarf 11.1 pc away with $P=2.71$ h. Using the method described in Section \ref{subsec:vsini}, we derived $v\sin i=$\input{values/449_vsini.txt} for \FB.
This yielded an inclination 
\subsubsection{\FC}
\label{sec:propsC}
%TIC 237
\FC is an M5 dwarf
