...
Using the method described in Section \ref{subsec:vsini}, we derived \input{values/277_vsini.txt} for \FA.
\subsubsection{\FB}
\label{sec:propsB}
%TIC 449
Using the method described in Section \ref{subsec:vsini}, we derived \input{values/449_vsini.txt} for \FB.
