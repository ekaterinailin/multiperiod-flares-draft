...
\\
Physically relevant aspects of flares are their temporal evolution across the electromagnetic spectrum, their statistical properties like energies and frequencies, and their impact on the circumstellar environment. In this study, we focus on a so far missing piece in the picture - the loci of flares on the stellar surface. %Kepler~\citep{borucki2010} and TESS~\citep{ricker2015} endowed us with large monitoring data sets at cadences as high as 1-2 min in the optical that are uniquely sui. We can infer energy budgets, frequencies~\citep{davenport2016, yang2019, guenther2020}, and details about the energy dissipation process from simultaneous spectroscopic observations~\citep{silverberg2016}. 
\\
...
%Compared to GJ65 A and B, TRAPPIST-1 (M8) rotates more than three to ten times slower, and shows a much weaker field. Mullan et al. 2018
%Are these stars all close-by? If yes, our results also extent the number of possible stars for which we can constrain the latitudes.
